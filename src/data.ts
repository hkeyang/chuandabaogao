...
export const REPORT_TYPES: ReportType[] = [
  {
    ...
    tags: ["发型发色", "色彩面部", "穿搭配饰", "场景 Look"],
    modules: ["发型", "发色", "色彩", "面部状态", "穿搭", "配饰", "场景建议"],
    asset: ASSETS.poster,
  },
  {
    id: "hair",
...
export const PERSONAS: Record<string, Persona> = {
  softFrench: {
    id: "softFrench",
    title: "清透松弛感",
    reportTitle: "清透松弛感形象报告",
    keywords: ["清透", "亲和", "低饱和", "松弛感"],
    summary: "不需要大改，增加轻盈和低饱和质感就会更出片。",
  ...
  koreanSchool: {
    id: "koreanSchool",
    title: "韩系干净感",
    reportTitle: "韩系干净感形象报告",
    keywords: ["干净", "亲和", "上镜", "少年感"],
    summary: "清新自然，干净耐看的上镜气质。",
    palette: ["#ffe8ef", "#edf5ff", "#c6dbef", "#f7d8c8", "#8c6f65"],
    tone: "米白、浅蓝、雾灰和轻韩系清爽感",
  },
  coolAiry: {
    id: "coolAiry",
    title: "清冷氧气感",
  ...
  sweetCool: {
    id: "sweetCool",
    title: "轻潮精致感",
    reportTitle: "轻潮精致感形象报告",
    keywords: ["精致", "时髦", "利落", "存在感"],
    summary: "有存在感但不过度，利落又耐看。",
